...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-xl px-6 py-24 text-center">
      <p className="font-mono text-[0.68rem] tracking-[0.2em] text-ember uppercase">404</p>
      ...
      <Link
        ...
        className={cn(
          buttonVariants(),
          "mt-8 inline-flex h-auto rounded-sm bg-ember px-5 py-3 text-cream hover:bg-ember-hot",
        )}
      >
        Back to DocFoundry
      </Link>
